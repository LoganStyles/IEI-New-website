...
Route::resource('about/management', 'PagesController');
...
Route::get('fetchLatestPrices','PagesController@fetchLatestPricesById');
Route::get('home', 'OfficeController@index')->name('office.home');
...
Route::get('office/menu/delete/{menu}/', 'OfficeController@destroy')->name('office.menu.delete');
...
Route::get('office/resources/{type}/delete/{id}/', 'OfficeController@destroy')->name('office.resources.resource.delete');
...
Route::get('office/accounts/{user}', 'UserController@index')->name('office.users.account');
Route::post('office/accounts/{user}', 'UserController@update')->name('office.users.account');
