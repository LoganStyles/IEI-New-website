                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="center-holder">
                        <ul id="myTab2" class="nav nav-pills boot-tabs">
                            <li class="nav-item"><a class="nav-link active" href="#home2" data-toggle="tab">DIRECTOR</a></li>
                            <li class="nav-item"><a class="nav-link" href="#profile2" data-toggle="tab">MANAGEMENT</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
