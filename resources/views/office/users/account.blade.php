    ...
    <div class="card-header"><strong>Profile</strong></div>
        <div class="card-body">
            <div class="row">
                ...
                @endif
                <form class="form-horizontal  col-md-12" method="POST" action="{{ route('office.users.account',strtolower($users->username)) }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                        ...
                        <input id="username" type="text" class="form-control" readonly="readonly" disabled="disabled" name="username" value="{{ $users->username }}" required>
